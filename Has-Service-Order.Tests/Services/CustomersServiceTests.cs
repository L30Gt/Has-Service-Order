...
namespace Has_Service_Order.Tests.Services
{
    public class CustomersServiceTests
    {
        ...
        public async Task Should_Return_A_List_Of_Customers()
        {
            ...
            {
                new Customer { Name = "Leonardo", Email = "email@email.com" , Phone = "11911112222", ServiceOrders = null },
                new Customer { Name = "Leo", Email = "email2@email.com", Phone = "11933332222", ServiceOrders = null }
        ...
        {
            int customerId = 1;
            Customer customer = new Customer { Id = customerId, Name = "Leo", Email = "email@email.com", Phone = "11912345678", ServiceOrders = null };
        ...
        {
            CreateCustomerDto newCustomer = new CreateCustomerDto("Leo", "email@email.com", "11912345678");
        ...
        {
            Customer existingCustomer = new Customer { Name = "Leo", Email = "email@email.com", Phone = "11912345678" };
            CreateCustomerDto customerDto = new CreateCustomerDto("AAA", "email@email.com", "11987654321");
        ...
        public async Task Should_Update_A_Existent_Customer()
        {
            ...
            CreateCustomerDto updatedCustomer = new CreateCustomerDto("Leo", "updatedemail@email.com", "11912345678");
